<template>
  <div class="publish-container">
    <el-card>
      <template #header>
        <span style="font-weight: bold; font-size: 16px">发布新需求</span>
      </template>
      <el-form
        :model="form"
        :rules="rules"
      ...
      >
        ...
        <el-form-item label="期望价格 (元)" prop="expectedPrice">
          <el-input-number
        ...
        <el-form-item label="期望时长 (小时)" prop="expectedDuration">
          <el-input-number
...
const rules = {
  ...
  tags: [
    { required: true, message: "请输入需求标签", trigger: "blur" },
  ...
  expectedDuration: [
    { required: true, message: "请输入期望时长", trigger: "blur" },
  ],
  expectedLocation: [
